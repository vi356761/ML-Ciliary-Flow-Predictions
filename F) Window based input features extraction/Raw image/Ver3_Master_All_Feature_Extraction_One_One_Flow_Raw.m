function [Master_Head_AllProps,Master_Midup_AllProps,Master_Middown_AllProps,Master_Tail_AllProps] = Ver3_Master_All_Feature_Extraction_One_One_Flow_Raw(pathi,blocksize,overlap,pf,thresh)
J = load([pathi,'Original_Final_Sections.mat']);
%..........................................................................................................................
%For cropped sections: Orginial Image
canvas1 = J.Sections11.Head;
canvas2 = J.Sections11.Tail;
canvas3 = J.Sections11.Midup;
canvas4 = J.Sections11.Middown;
%..........................................................................................................................
figure; 
...
canvass1 = logical(xExpandMatrix(canvas1, 1, 1, blocksize, blocksize, blocksize, blocksize, 0));
canvass2 = logical(xExpandMatrix(canvas2, 1, 1, blocksize, blocksize, blocksize, blocksize, 0));
canvass3 = logical(xExpandMatrix(canvas3, 1, 1, blocksize, blocksize, blocksize, blocksize, 0));
canvass4 = logical(xExpandMatrix(canvas4, 1, 1, blocksize, blocksize, blocksize, blocksize, 0));
...
%% Get Lamda and Gamma
[centx1, centy1, All_Props1, n1, ro1, re1, stdro1, uniformity1, minima1, lamda1, gamma1] = windowmethod_ensembledtissueparam(Master_Images_Col1,thresh); %Head
[centx2, centy2, All_Props2, n2, ro2, re2, stdro2, uniformity2, minima2, lamda2, gamma2] = windowmethod_ensembledtissueparam(Master_Images_Col2,thresh); %Tail
[centx3, centy3, All_Props3, n3, ro3, re3, stdro3, uniformity3, minima3, lamda3, gamma3] = windowmethod_ensembledtissueparam(Master_Images_Col3,thresh); %Mid-up
[centx4, centy4, All_Props4, n4, ro4, re4, stdro4, uniformity4, minima4, lamda4, gamma4] = windowmethod_ensembledtissueparam(Master_Images_Col4,thresh); %Mid-down
%% Create Savepath:
svpath = ([pathi,'RawData\']);
if(exist(svpath)~=7)
    mkdir(svpath)
end
...
CF_Tail = sum(All_Props2.Area{jj,1})/(448*448);
...
CF_Midup = sum(All_Props3.Area{jj,1})/(448*448);
...
CF_Middown = sum(All_Props4.Area{jj,1})/(448*448);
...
%% Gather only means together and normalize 
%1) Gather and Normalize Area
Area_Master_Table = groupunevenmatrix(Head_Area_Mean,Midup_Area_Mean,Middown_Area_Mean,Tail_Area_Mean);%Head,Mid-up,Middown,Tail
Area_Master = table2array(Area_Master_Table);
[Head_Area_norm, Midup_Area_norm, Middown_Area_norm,Tail_Area_norm,Area_norm_Ensembled] = Features_Normalize(Area_Master);
%With outliers removed if needed
[Head_rmo, Midup_rmo, Middown_rmo, Tail_rmo, Area_Ensembled_rmo] = Features_Rmoutliers(Area_Master);
Area_Ensembled_rmo2 = table2array(Area_Ensembled_rmo);
[~,~,~,~,Area_norm_Ensembled_rmo] = Features_Normalize(Area_Ensembled_rmo2);
