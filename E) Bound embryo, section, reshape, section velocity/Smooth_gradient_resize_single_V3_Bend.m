...
%Compress
function [Temp_Emb,xistep,Rat] = Smooth_gradient_resize_single_V3_Bend(Bound_img2,Bound_img12,direc1)
%crpup = crp-crpdn;
...
%hstp = stps/2;
if(strcmpi(direc1,'sideup'))
    xs1 = round(linspace(xmid,1,xmid)).';
    xs2 = round(linspace(1,xmid,xmid)).';
