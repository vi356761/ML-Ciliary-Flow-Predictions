function V2_vizualize_exp_divergence(maspath,revimg,imgtitle,ylbl,blocksize)
...
ET = [ET1;ET2;ET3;ET4];
ET1_Div_Norm = normalize(ET.Divergence,'Range',[0 1]);
[~,~,idx] = histcounts(ET1_Div_Norm);

ET_Head = ET1_Div_Norm(1:length(ET1.Divergence),:);
%ET_Head(ind1)=0;

ET_Mu = ET1_Div_Norm(length(ET1.Divergence)+1:length(ET1.Divergence)+length(ET2.Divergence),:);
%ET_Mu(ind2)=0;

ET_Md = ET1_Div_Norm(length(ET1.Divergence)+length(ET2.Divergence)+1:length(ET1.Divergence)+length(ET2.Divergence)+length(ET3.Divergence),:);
%ET_Md(ind3)=0;

ET_Tail = ET1_Div_Norm(length(ET1.Divergence)+length(ET2.Divergence)+length(ET3.Divergence)+1:end,:);
%ET_Tail(ind4)=0;
%................................................................................................................................................................................
