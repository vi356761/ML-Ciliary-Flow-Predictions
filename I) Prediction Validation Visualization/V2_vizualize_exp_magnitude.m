function V2_vizualize_exp_magnitude(maspath,revimg,imgtitle,ylbl,blocksize)
...
%................................................................................................................................................................................
% DIVERGENCE
% ET1 = readtable([maspath,'Win 150\Divergence_Features\Head_Master_Tol.xlsx'],'range','M:M');
% ind1 = find(ET1.Divergence==0);
% ET2 = readtable([maspath,'Win 150\Divergence_Features\Midup_Master_Tol.xlsx'],'range','M:M');
% ind2 = find(ET2.Divergence==0);
% ET3 = readtable([maspath,'Win 150\Divergence_Features\Middown_Master_Tol.xlsx'],'range','M:M');
% ind3 = find(ET3.Divergence==0);
% ET4 = readtable([maspath,'Win 150\Divergence_Features\Tail_Master_Tol.xlsx'],'range','M:M');
% ind4 = find(ET4.Divergence==0);

ETT1 = readtable([maspath,'Velocity_Features\Head_Master_RMS.xlsx'],'range','A:J');
ETT2 = readtable([maspath,'Velocity_Features\Midup_Master_RMS.xlsx'],'range','A:J');
ETT3 = readtable([maspath,'Velocity_Features\Middown_Master_RMS.xlsx'],'range','A:J');
ETT4 = readtable([maspath,'Velocity_Features\Tail_Master_RMS.xlsx'],'range','A:J');
...
%ET_Tail(ind4)=0;
%................................................................................................................................................................................
ET_Head_idx = idx(1:length(ET1.Magnitude),:);
%ET_Head_idx(ind1)=0;

ET_Mu_idx = idx(length(ET1.Magnitude)+1:length(ET1.Magnitude)+length(ET2.Magnitude),:);
%ET_Mu_idx(ind2)=0;

ET_Md_idx = idx(length(ET1.Magnitude)+length(ET2.Magnitude)+1:length(ET1.Magnitude)+length(ET2.Magnitude)+length(ET3.Magnitude),:);
%ET_Md_idx(ind3)=0;

ET_Tail_idx = idx(length(ET1.Magnitude)+length(ET2.Magnitude)+length(ET3.Magnitude)+1:end,:);
%ET_Tail_idx(ind4)=0;
%%
...
% xlim(axes1,[0.5 2651.5]);
% ylim(axes1,[0.5 1175.5]);
